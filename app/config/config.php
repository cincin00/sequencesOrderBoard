...
// 벤더 폴더
define('VENDER', DOMAIN.'/public/vender');
// 공용 css 폴더
...
// 사이트 최상위 폴더
define('PATH_ROOT','/opt/homebrew/var/www/board01/public_html');
// 관리자 플러그인 폴더
...
define('ADMIN_DIR', DOMAIN.'/app/pages/admin');
//define('ADMIN_PAGES_DIR', DOMAIN.'/app/pages/admin/pages');
